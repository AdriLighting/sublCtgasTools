...
#include <D:\programmation_code\Autoit\Autoit_Scripts\Autoit_Scripts_Source\UDF\_ADFunc.au3>
#include <D:\programmation_code\Autoit\Autoit_Scripts\Autoit_Scripts_Source\UDF\ArrayMultiColSort.au3>
...
$fp_fileRead = "D:\programmation_code\Arduino\Arduino_Projet\0A_projet\2_mylib_v1\lib\arduino_patternsList\src\program.cpp"
					...
					If $aSelIndices[0] > 0 Then
						...
						Else
							...
							if FileExists($sNewPAth) Then
								...
								;~ 		if ($cpp_getTags_array[$aItems][6]<>"")Then
								;~ 		Else
								;~ 			if StringInStr($line_doc, $cpp_getTags_array[$aItems][2] & $cpp_getTags_array[$aItems][0] & $cpp_getTags_array[$aItems][11]) then ConsoleWrite($line_doc&@lf)
								;~ 		EndIf
								;~ 		ConsoleWrite( $cpp_getTags_array[$aItems][2] & $cpp_getTags_array[$aItems][0] & $cpp_getTags_array[$aItems][11]&@lf)
